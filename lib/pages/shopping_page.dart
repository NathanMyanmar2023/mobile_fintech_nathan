...
class ShoppingPage extends StatefulWidget {
  ...
  const ShoppingPage(
      {super.key, required this.brandId, required this.categoryId});
...
class _ShoppingPageState extends State<ShoppingPage> {
  ...
  Future fetch() async {
    widget.brandId == 0
        ? _shoppingBloc.getCategoryProducts(
    ...
    if (hasMore == true) {
      ...
      widget.brandId == 0
          ? _shoppingBloc.getCategoryProducts(
              categoryId: widget.categoryId, page: page)
          : _shoppingBloc.getShoppingProduct(
              brandId: widget.brandId, page: page);
