                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) =>
                            ...
                            children: [
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Image.network(
                                        orderDetailData?.items?.products?[index]
                                                .photo ??
                                            "",
                                        height: 80,
                                        width: 80,
                                              ...
                                              Row(
                                                  ...
                                                  children: [
                                                    OrderInfoView(
                                                      infoTitle: "Price",
                                                      infoMsg:
                                                          "${orderDetailData?.items?.products?[index].discountPrice}",
                                                    ),
                                                    OrderInfoView(
                                                      infoTitle: "Qty",
                                                      infoMsg:
                                                          "${orderDetailData?.items?.products?[index].quantity}",
                                                    ),
                                                    OrderInfoView(
                                                      infoTitle: "Total",
                                                      infoMsg:
                                                          "${double.parse("${orderDetailData?.items?.products?[index].quantity}") * double.parse("${orderDetailData?.items?.products?[index].discountPrice}")}",
                                                    ),
                                                  ]),
                                            ],
                                          ),
                              ...
                              index !=
                                      orderDetailData!.items!.products!.length -
                                          1
                                  ? const Divider(
                                      height: 1,
                                      color: colorSeconary,
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            NathanTextView(
                              text: money_format(
                                  "${orderDetailData?.items?.deliveryFees}"),
                              color: colorBlack,
                              fontWeight: FontWeight.w600,
                              fontSize: 18,
                            ),
