...
import 'package:nathan_app/bloc/cart_bloc.dart';
import 'package:nathan_app/bloc/delete_cart_bloc.dart';
import 'package:nathan_app/bloc/update_cart_bloc.dart';
import 'package:nathan_app/extensions/navigation_extensions.dart';
import 'package:nathan_app/helpers/response_ob.dart';
import 'package:nathan_app/objects/cart_ob.dart';
import 'package:nathan_app/pages/check_out_page.dart';
 ...
 // int? totalAmount = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:
      cart == null ? const Center(
        child: Text("No More Data"),
      ) : cart!.items!.isEmpty ? const Center(
        child: Text("No More Data"),
      ) : Column(
        children: [
         Expanded(
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    InkWell(
                                        onTap: (){
                                          _deleteCartBloc.deleteShoppingCart(
                                            id: cart?.items?[index].cartId ?? 0,
                                          );
                                                          },child: const Icon(Icons.delete_forever, color: Colors.red, size: 23,)),
                                  ],
                                ),
                                ...
                                cart?.items?[index].productDiscount != null ? cart!.items![index].productDiscount! > 0 ?
                                Text(
                              ...
                              children: [
                                InkWell(
                                  onTap: () {
                                    ...
                                    setState(() {
                                      if ((cart?.items?[index].productQuality ??
                                          1) < cart!.items![index].onHandStock!) {

                                        cart?.items?[index].productQuality =
                                            (cart?.items?[index].productQuality ?? 1) + 1;
                                      }
                                      if(cart?.items?[index].productQuality == cart?.items?[index].onHandStock) {
                                ...
                                InkWell(
                                  onTap: () {
                                    print("first ${cart?.items?[index].productQuality}");
                                    setState(() {
                                      if ((cart?.items?[index].productQuality ?? 1) > 1) {
                                        cart?.items?[index].productQuality =
                                            (cart?.items?[index].productQuality ?? 1) - 1;
                                        print("foe2 ${cart?.items?[index].productQuality}");
                                        print("localItem-dd1 $totalAmount");
                              ...
                              style: const TextStyle(
                                ...
                                fontWeight: FontWeight.bold,
                                   ...
                                   IconButton(
                                    ...
                                    icon: const Icon(Icons.arrow_circle_up, color: colorPrimary,),
                                  ),
                            // Row(
                            //   children: [
                            //     Container(
