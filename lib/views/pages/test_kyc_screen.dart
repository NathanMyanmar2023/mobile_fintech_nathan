...
class TestKycScreen extends StatefulWidget {
  const TestKycScreen({
    super.key,
  });

  @override
  State<TestKycScreen> createState() => _TestKycScreenState();
}

class _TestKycScreenState extends State<TestKycScreen> {
          ...
          appBar: PreferredSize(
            ...
            child: Padding(
              ...
              child: AppBar(
                ...
                title: Text(
                  "hi ${AppLocalizations.of(context)!.kyc_info}",
                  style: TextStyle(
                    fontSize: 18,
                    color: colorPrimary,
                  ),
