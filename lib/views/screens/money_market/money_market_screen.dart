...
import 'package:nathan_app/bloc/money_market/bill_auction_bloc.dart';
                    ...
                    child: AspectRatio(
                      ...
                      child: Stack(
                        children: [
                          InkWell(
                            onTap: () {
                              if(billAuctionList[index].stardardLimit == billAuctionList[index].existingUsers
                                  && billAuctionList[index].authUserHasStatus == 0){
                                print("can'");
                              }else {
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: billAuctionList[index].authUserHasStatus == 0
                                      ? colorPrimary
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Row(crossAxisAlignment: CrossAxisAlignment.start,
                                        ...
                                        children: [
                                          Text("${billAuctionList[index].title}",
                                            style: const TextStyle(
                                              fontSize: 17,
                                              fontWeight: FontWeight.bold,
                                            ),
                                          ),
                                          Text("${billAuctionList[index].amount}",
                                            style: const TextStyle(
                                              fontSize: 14,
                                      ...
                                      RowIconText(
                                        ...
                                        name: "${billAuctionList[index].startMonth}",
                                      ),
                                      RowIconText(
                                        icon: Icons.group,
                                        name: "${billAuctionList[index].stardardLimit} persons",
                                      ),
                                      billAuctionList[index].stardardLimit == billAuctionList[index].existingUsers ? const SizedBox()
                                          : RowIconText(
                                        icon: Icons.person_add_alt_1_outlined,
                                        name: "${billAuctionList[index].leftUser} ${billAuctionList[index].leftUser! > 1 ? "persons" : "person"}",
                                      ),
                                    ],
                                  )
                              ),
