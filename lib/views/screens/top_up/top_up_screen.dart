                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                TopUpButtonWidget(
                                  amt_name: '1,000',
                                  target: () =>
                                      alertTopUpPay('1,000', newData!.name!),
                                ),
                                const SizedBox(
                                  width: 5,
                                ),
                                TopUpButtonWidget(
                                  amt_name: '2,000',
                                  target: () =>
                                      alertTopUpPay('2,000', newData!.name!),
                                ),
                                const SizedBox(
                                  width: 5,
                                ),
                                TopUpButtonWidget(
                                  amt_name: '3,000',
                                  target: () =>
                                      alertTopUpPay('3,000', newData!.name!),
                                ),
                              ],
                            ),
                          ),
                            ...
                            child: Row(
                              ...
                              children: [
                                TopUpButtonWidget(
                                  amt_name: '4,000',
                                  target: () =>
                                      alertTopUpPay('4,000', newData!.name!),
                                ),
                                const SizedBox(
                                  width: 5,
                                ),
                                TopUpButtonWidget(
                                  amt_name: '5,000',
                                  target: () =>
                                      alertTopUpPay('5,000', newData!.name!),
                                ),
                                const SizedBox(
                                  width: 5,
                                ),
                                TopUpButtonWidget(
                                  amt_name: '10,000',
                                  target: () =>
                                      alertTopUpPay('10,000', newData!.name!),
                                ),
                              ],
                            ),
                          ),
                            ...
                            child: Row(
                              ...
                              children: [
                                TopUpButtonWidget(
                                  amt_name: '20,000',
                                  target: () =>
                                      alertTopUpPay('20,000', newData!.name!),
                                ),
                                const SizedBox(
                                  width: 5,
                                ),
                                TopUpButtonWidget(
                                  amt_name: '30,000',
                                  target: () =>
                                      alertTopUpPay('30,000', newData!.name!),
                                ),
                              ],
                            ),
                          ),
                          Padding(
                            ...
                            child: CustomAmountWidget(
                              label: "Custom Amount",
                              hintText: "Other Amount",
                              controller: otherAmtController,
                              billFunction: () => alertTopUpPay(
                                  otherAmtController.text.trim(),
                                  newData!.name!),
                            ),
                          ),
                        ],
                      ...
                      Padding(
                        ...
                        child: LongButtonView(
                          ...
                          onTap: () async {
                            ...
                            print(
                                "fullph $_phone_code${phoneController.text.trim()}");
                            ...
                            if (phoneController.text.trim().length == 8) {
                            ...
                            } else if (newData!.name!.toLowerCase() == "mpt") {
                              List<String> mptList = [
                                "25",
                                "26",
                                "27",
                              ...
                              opType = mptList.contains(phone)
                                  ...
                                  : "";
                              print("type $opType");
                            } else if (newData!.name!.toLowerCase() == "atom") {
                              ...
                              opType = atomList.contains(phone)
                                  ? "${newData!.id}"
                                  : "";
                              print("type $opType");
                              ...
                              opType = mytelList.contains(phone)
                                  ? "${newData!.id}"
                                  : "";
                              print("type $opType");
                            }
