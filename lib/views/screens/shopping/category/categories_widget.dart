...
class _CategoriesWidgetState extends State<CategoriesWidget> {
  ...
  void initState() {
    ...
    _categoryStream.listen((ResponseOb resp) {
      categoryViewList.add(CategoryViewData(
          id: 0,
          name: "Top Categories",
          photo:
            ...
            Row(
              ...
              children: List.generate(
                ...
                (index) => Padding(
                  ...
                  child: RawChip(
                    backgroundColor: categoryViewList[index].id == 0
                        ? colorPrimary
                        : colorPrimary.withOpacity(0.6), //Colors.grey.shade200,
                    labelPadding:
                        EdgeInsets.symmetric(horizontal: 3.w, vertical: 0.h),
                    label: Text(
                      categoryViewList[index].name ?? "",
                      style: TextStyle(
                        color: colorWhite,
                        fontFamily: "Regular",
