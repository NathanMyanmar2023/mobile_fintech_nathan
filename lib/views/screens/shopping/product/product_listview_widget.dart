...
import 'package:fnge/views/screens/shopping/product/product_card_component.dart';
...
class ProductListViewWidget extends StatefulWidget {
  ...
  const ProductListViewWidget(
      {Key? key, required this.mainTitle, required this.tagName})
      : super(key: key);
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (BuildContext context) => AllProductScreen(
