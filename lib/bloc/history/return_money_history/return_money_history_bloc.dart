...
import 'package:nathan_app/objects/history/return_money_history_ob.dart';
...
class ReturnMoneyHistoryBloc extends BaseNetwork {
  ...
  Stream<ResponseOb> returnMoneyHistoryStream() => returnMoneyHistoryController.stream;

  getReturnMoneyHistory(int page) async {
    getReq("${API_URL}history/final_return_money?page=$page", onDataCallBack: (ResponseOb resp) {
