...
import 'package:nathan_app/objects/history/exchange_history_ob.dart';
...
class ExchangeHistoryBloc extends BaseNetwork {
  ...
  Stream<ResponseOb> exchangeHistoryStream() => exchangeHistoryController.stream;

  getExchangeHistory(int page) async {
    getReq("${API_URL}history/exchange?page=$page", onDataCallBack: (ResponseOb resp) {
